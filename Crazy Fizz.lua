...
if AUTOUPDATE then
	local ServerData = GetWebResult(UPDATE_HOST, "/CrazyDud/BoL/master/version/Crazy Fizz.version")
	if ServerData then
...
function OnLoad()
    ...
    HPred:AddSpell("R","Fizz", {collisionM = false, collisionH = false, delay = 0.5, range = 1275, speed = 1200, type = "DelayLine", width = 80, IsLowAccuracy = true})
	VP = VPrediction(true)
end
